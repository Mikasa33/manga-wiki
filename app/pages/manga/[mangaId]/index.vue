...
const { data: subjects } = await useFetch<any>(`https://api.bgm.tv/v0/subjects/${mangaId}/subjects`)

const formattedCharacters = useArrayMap(characters.value, formatCharacter)
